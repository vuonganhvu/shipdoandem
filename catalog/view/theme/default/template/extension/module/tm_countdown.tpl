<div class="container">
	<div class="box countdown">
		...
		<div class="box-content">
			...
			<?php } ?>
			<?php if ($type == 1) { ?>
			<div id="radial-countdown<?php echo $module; ?>" class="radial-countdown" data-date="<?php echo $date ?>"></div>
			<?php } else { ?>
			<div id="countdown<?php echo $module; ?>" class="countdown-simple" data-date="<?php echo $date ?>">
