...
<div class="box blog_articles">
	...
	<div class="box-content">
		...
		<?php foreach ($articles as $article) {  ?>
			<div class="col-sm-4 blog-item" data-match-height="items-b">
				<?php if ($show_image == 1) { ?>
				<figure class="article-image">
					<img width="<?php echo $article['image_width']; ?>" height="<?php echo $article['image_height']; ?>" src="<?php echo $article['image']; ?>" alt="<?php echo $article['article_title'] ?>"/>
					<?php if ($show_date == 1) {?>
