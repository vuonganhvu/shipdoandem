<div class="box twitter soc_info">
	...
	<div id="twitterRefresher" class="box-content">
		<a class="twitter-timeline" width="<?php echo $width; ?>" height="<?php echo $height; ?>" data-theme="<?php echo $color_scheme; ?>" href="<?php echo $page_url; ?>" data-tweet-limit="<?php echo $tweet_limit; ?>" data-widget-id="<?php echo $widget_id; ?>">
		</a>
	</div>
</div>
