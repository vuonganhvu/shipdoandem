<?php
    class ControllerSimpleBlogReport extends Controller {
    	...
    	public function getData() {
    		$this->load->language('simple_blog/report');
			...
			$data['breadcrumbs'][] = array(
				...
				'href'      => $this->url->link('simple_blog/report', 'user_token=' . $this->session->data['user_token'] . $url, true),
				'separator' => ' :: '
			);
			...
			$data['sort_article_title'] = $this->url->link('simple_blog/report', 'user_token=' . $this->session->data['user_token'] . '&sort=sbad.article_title' . $url, true);
			$data['sort_author_name'] = $this->url->link('simple_blog/report', 'user_token=' . $this->session->data['user_token'] . '&sort=sbau.name' . $url, true);
			$data['sort_view'] = $this->url->link('simple_blog/report', 'user_token=' . $this->session->data['user_token'] . '&sort=sbv.view' . $url, true);			
			...
			$pagination->url = $this->url->link('simple_blog/report', 'user_token=' . $this->session->data['user_token'] . '&page={page}', true);
