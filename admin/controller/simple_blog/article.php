...
class ControllerSimpleBlogArticle extends Controller {
	...
	public function insert() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && ($this->validateForm())) {
			...
			$this->response->redirect($this->url->link('simple_blog/article', 'user_token=' . $this->session->data['user_token'] . $url, true));				
		}
	...
	public function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('simple_blog/article', 'user_token=' . $this->session->data['user_token'] . $url, true),
			'separator' => ' :: '
			);
		
		$data['insert'] = $this->url->link('simple_blog/article/insert', 'user_token=' . $this->session->data['user_token'] . $url, true);
		$data['delete'] = $this->url->link('simple_blog/article/delete', 'user_token=' . $this->session->data['user_token'] . $url, true);
		...
		foreach($results as $result) {
			$data['articles'][] = array(
				...
				'edit'          	=> $this->url->link('simple_blog/article/update', 'user_token=' . $this->session->data['user_token'] . '&simple_blog_article_id=' . $result['simple_blog_article_id'] . $url, true)
				);		
		}
		...
		$data['sort_article_title'] = $this->url->link('simple_blog/article', 'user_token=' . $this->session->data['user_token'] . '&sort=sbad.article_title' . $url, true);
		$data['sort_author_name'] = $this->url->link('simple_blog/article', 'user_token=' . $this->session->data['user_token'] . '&sort=sbau.name' . $url, true);
		$data['sort_sortorder'] = $this->url->link('simple_blog/article', 'user_token=' . $this->session->data['user_token'] . '&sort=sba.sort_order' . $url, true);
		$data['sort_status'] = $this->url->link('simple_blog/article', 'user_token=' . $this->session->data['user_token'] . '&sort=sba.status' . $url, true);
		$data['sort_date_added'] = $this->url->link('simple_blog/article', 'user_token=' . $this->session->data['user_token'] . '&sort=sba.date_added' . $url, true);
		...
		$pagination->url = $this->url->link('simple_blog/article', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', true);
	...
	public function getForm() {
		...
		if (!isset($this->request->get['simple_blog_article_id'])) {
			$data['action'] = $this->url->link('simple_blog/article/insert', 'user_token=' . $this->session->data['user_token'] . $url, true);
		} else {
			$data['action'] = $this->url->link('simple_blog/article/update', 'user_token=' . $this->session->data['user_token'] . '&simple_blog_article_id=' . $this->request->get['simple_blog_article_id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('simple_blog/article', 'user_token=' . $this->session->data['user_token'] . $url, true);
